                  ...
                  <div class="col-lg-6">
                    <div class="card-body p-md-5 mx-md-4">
                      ...
                      <div class="text-center">
                        ...
                        <h4 class="mt-1 mb-5 pb-1">HMS Patient Login</h4>
                      </div>
                      ...
                      <form method="post">
                        ...
                        <div class="d-flex align-items-center justify-content-center pb-4">
                          <p class="mb-0 md-2" style="padding-right: 1rem;">Don't have an account?</p>
                          <a button type="button" class="btn btn-outline-danger" href="registration.php">Create new</a>
                        </div>
